            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                    <h3 class="timeline-header"><b>Judul : </b><a href="/pertanyaan/{{ $question->id }}">{{ $question->title }}</a></h3>
                  <div class="timeline-body">{{ $question->content }}</div>
              ...
              <div>
                ...
                <div class="timeline-body">{{ $answer->content }}</div>
                <div class="timeline-footer">
